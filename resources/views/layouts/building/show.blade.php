            ...
            <div class="space-y-4">
                <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-xs bg-gray-100 text-gray-500 px-3 py-1 rounded-full">Building</span>
                        <span class="text-xs text-gray-400">#{{ $property->id }}</span>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900">${{ number_format($property->price, 2) }}</p>
                    </div>

                    <hr class="border-gray-100">

                    {{-- number_of_building + image count --}}
