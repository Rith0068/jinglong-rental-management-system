...
<body>
    <div class="flex">
        <div class="block m-auto w-[440px] border-black shadow-2xl rounded-lg mt-[100px] h-[510px] bg-white-100">
            <div class="flex">
            ...
            <form action="" class="pl-[50px]">
                ...
                <label>
                    ...
                    <input type="" id="password" placeholder="fill your password here" class="border-gray-800 text-gray-500 p-[10px] w-[330px] bg-gray-50 font-bold rounded-lg hover:text-gray-800 mt-1">
                </label>
            ...
            <div class="pl-[50px] flex justify-between pr-[50px]">
                <button class="mt-[20px] bg-blue-400 p-[10px] w-[150px] rounded-lg shadow font-bold text[16px] text-gray hover:text-gray-50 hover:shadow-blue-300 hover:p-[11px] hover:w-[150px]">
                    Login
                </button>
